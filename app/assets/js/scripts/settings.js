...
function populateSettingsUpdateInformation(data){
    if(data != null){
        ...
        if(process.platform === 'darwin'){
            settingsUpdateButtonStatus('디스코드에서 다운로드하세요.<span style="font-size: 10px;color: gray;text-shadow: none !important;">런처를 닫고, dmg파일을 열어주세요.</span>', false, () => {
        ...
        settingsUpdateTitle.innerHTML = '최신 버전을 사용하고 계십니다.'
